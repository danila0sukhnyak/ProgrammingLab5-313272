...
public class DBController {
    ...
    public boolean add(MusicBand musicBand) throws SQLException {
    ...
    public boolean update(MusicBand musicBand) throws SQLException {
    ...
    public void remove(Long id) throws SQLException {
        final String sql = "DELETE FROM MUSIC_BAND WHERE id=?";
        final PreparedStatement preparedStatement = connection.prepareStatement(sql);
        preparedStatement.setLong(1, id);
        preparedStatement.executeUpdate();
    }
    ...
    public void clear(String user) throws SQLException {
        final String sql = "DELETE FROM MUSIC_BAND WHERE USER_LOGIN=?";
        final PreparedStatement preparedStatement = connection.prepareStatement(sql);
